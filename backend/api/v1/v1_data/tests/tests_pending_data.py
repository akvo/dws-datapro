...
# from api.v1.v1_data.models import PendingDataApproval, FormData
...
class PendingDataTestCase(TestCase):
    ...
    #     call_command(
    # 'fake_pending_data_seeder', '-r', 5, '-t', True, '-b', 5
    # )
    ...
    #       len(rejected_response.json().get('batch')), 0
    #     )
