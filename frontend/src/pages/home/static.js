...
export const mandate = {
  title: "Our Mandate",
  text: "The Department of Water and Sewerage is mandated with the responsibility of ensuring a sustainable water and sewerage sector through the development of innovative policies, efficient service delivery, and rigorous compliance monitoring.",
};

export const structure = {
  title: "Department Structure",
  text: "The Department is headed by the Director of Water and Sewerage with the Technical Unit responsible for monitoring and compliance and Policy Unit responsible for policy and regulatory matters, supported by common cadre support staff.",
  image: {
...
export const keyRoles = {
  ...
  text: "The key roles and responsibilities of the Department include policy and legislation development, technical and policy advisory, compliance monitoring, and Water Authority of Fiji oversight.",
  items: [
    {
      imgSrc:
