...
Network Config: -
`setupProxy.js <https://github.com/akvo/iwsims/blob/main/frontend/src/setupProxy.js>`__
-
`mainnetwork <https://github.com/akvo/iwsims/blob/docker-compose.override.yml#L4-L8>`__
container setup
