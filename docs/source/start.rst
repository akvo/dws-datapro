...
Users who have been registered in the MIS platform will receive an invitation email to complete the account setup process. Click the Set Password button to activate your account. Make sure you are on the testing url dws-datapro.akvo.org. Set a strong password and click Set New Password to login to your account.
