const uiText = {
  en: {
    ...
    manageNewBlank: 'Registration Form',
    manageUpdate: 'Monitoring Form',
    manageEditSavedForm: 'Edit Saved Forms',
    manageViewSubmitted: 'View Submitted Forms',
  ...
  fr: {
    ...
    manageNewBlank: "Formulaire d'inscription",
    manageUpdate: 'Formulaire de surveillance',
    manageEditSavedForm: 'Modifier les formulaires enregistrés',
    manageViewSubmitted: 'Afficher les formulaires soumis',
